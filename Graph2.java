...
public class Graph2 { //graph class
    ...
    static void createGraph1(int[][] flights, ArrayList<Edge> graph[]) { // create a graph pblm 
    ...
    public static void prims(ArrayList<Edge> graph[]) {// prims  pblm 
        boolean vis[] = new boolean[graph.length];
    ...
    static class Info{  // cheapest flights with k spots  pblm
        int v;
        int cost;
        int stops;
    ...
    static void createGraph1(ArrayList<Edge2> edges) { // create graph  pblm
    ...
    public static void union1(int a, int b) { // union pblm 
        int parA = find(a);
        int parB = find(b);
    ...
    public static void KruskalMST(ArrayList<Edge2> edges, int V) { // kruskal Mst  pblm 
        init1();
    ...
    public static int[][] floodFill(int[][] image, int sr, int sc, int color) { // flood fill  pblm 
