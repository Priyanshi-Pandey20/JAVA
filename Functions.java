...
public class Functions {
    ...
    public static void CountAllDigits(int n) { // count all digits pblm 
        int count = 0;
        while (n != 0) {
            n /= 10;
            count++;
    ...
    public static void PrintReverseNo(int n) { // print reverse no. pblm  
        int rev = 0;
        while (n != 0) {
            int digit = n % 10;
            rev = rev * 10 + digit;
    ...
    public static void PrintPrimeNoInRange(int st, int end) { // print prime no in range pblm 
