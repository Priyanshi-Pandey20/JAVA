...
public class DynamicProgramming {
    ...
    public static int fibbonacci(int[] f, int n) { // print nth fibbonaci  pblm 
        int[] dp = new int[n + 1];
        dp[0] = 0;
        dp[1] = 1;
    ...
    public static boolean targetSumSubset(int[] arr, int sum) { // target sum pblm 
        int n = arr.length;
    ...
    public static int longestCommonSubsequence(String str1, String str2, int n, int m, int dp[][]) { // lcs using
                                                                                                     // memoization
    ...
    public static int editDistance(String str1,String str2){  // edit distance problem 
        int n = str1.length();
        int m = str2.length();
        int[][] dp = new int[n+1][m+1];
