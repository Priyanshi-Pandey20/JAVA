...
class Moniter extends Student {
    void checkdispline() { // checkdispline class 
...
class Laptop extends Device { // laptop class 
    void boot() { // boot
        System.out.println("Laptop is booting");
    }
}

class GamingLaptop extends Laptop { // gaming laptop class
...
class Puppy extends Dog {  //puppy class
    void cute() {// cute
...
class Circle implements Shape2 { // circle class implememnts shape2
