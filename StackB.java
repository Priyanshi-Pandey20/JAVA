...
public class StackB {
    ...
    public static void reverseStack(Stack<Integer> s) { // reverse the stack element pblm 
        if (s.isEmpty()) {
            return;
        }
        int top = s.pop();
    ...
    public static void LargestRectangleInHistogram(int[] arr) { // O(n) largest area of histogram pblm
        int maxArea = 0;
