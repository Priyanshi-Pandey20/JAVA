...
public class BinaryTreesB {// binary tree class
    ...
    public static int TransformToSumTree(Node root) { // transform the tree to sum tree pblm
        if (root == null) {
            return 0;
        }
    ...
    public static int countLeafNodes(Node root) { // count all the leaf nodes pblm 
        if (root == null)
            return 0;
