...
public class CustomArrayList {
   public static void ReverseArrayList() { // reverse arraylist pblm 
   ...
   public static int storeWater(ArrayList<Integer> height) { // O(n^2) store water brute force approach pblm  
      int maxWater = 0;
   ...
   public static int StoreWater(ArrayList<Integer> height) { // store water optimal approach pblm 
      int maxWater = 0;
      int lp = 0;
   ...
   public static boolean TwoSum(ArrayList<Integer> list, int target) { // two sum for liner list pblm
      int lp = 0;
      int rp = list.size() - 1;
      while (lp != rp) {
   ...
   public static ArrayList<Integer> BeautifulArrayList(int n) { // Beautiful Arraylist pblm
