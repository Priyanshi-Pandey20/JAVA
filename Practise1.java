...
public class Practise1 {
    public static void main(Demo args[]) {
        ...
        char c = scn.next().charAt(0); // Q4  // vowel consonent pblm 
        switch (c) {
            case 'a':
            case 'e':
            case 'i':
            ...
            default:
                ...
                int f = scn.nextInt(); // Q7 print the table of given no.  pblm
                for (int i = 1; i <= 10; i++) {
                    int table = i * f;
                    System.out.println(table);
                }

                int k = scn.nextInt(); // Q8 // check whether the given  no. is divisble or not pblm
